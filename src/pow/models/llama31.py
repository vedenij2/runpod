# Thanks to Andrej Karpathy for the original implementation
...
class Transformer(nn.Module):
    ...
    def forward(self, h: torch.Tensor, start_pos: int):
        return self.forward_embedding(h, start_pos)
...
class Llama:
    ...
    def build(
        ...
        assert os.path.isfile(params_path), f"Params file '{params_path}' does not exist."
